...
# Perform subtyping
res <- BS_parker(gene_expr = OSLO2EMIT0obj$data_input$x_NC.log, pheno = NULL, calibration = "Internal", internal = "medianCtr", Subtype = FALSE, hasClinical = FALSE)
...
genes <- as.character(genes.s$EntrezGene.ID[genes.s$AIMS == "Yes"])

# Perform subtyping
res <- BS_AIMS(gene_expr = OSLO2EMIT0obj$data_input$x_SSP[genes, ], EntrezID = rownames(OSLO2EMIT0obj$data_input$x_SSP[genes, ]))
...
-   Yang, Q. [aut] & Sifakis, E. G. [cre], *BreastSubtypeR: Streamlining Molecular Intrinsic Subtyping for Breast Cancer*. Available at: <https://github.com/JohanHartmanGroupBioteam/BreastSubtypeR>.
