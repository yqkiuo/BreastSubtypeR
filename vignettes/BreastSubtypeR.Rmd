...
Here's an example of using **BreastSubtypeR**'s **Multi-Method** subtyping functionality for breast cancer subtyping:
```R
...
Here's an example of using **BreastSubtypeR** for breast cancer subtyping with the **Multi-Method** subtyping functionality and **AUTO Mode** enabled. The AUTO Mode automatically selects methods based on the ER/HER2 distribution of the test cohort:
```R
library(BreastSubtypeR)
...
Here's an example of using **BreastSubtypeR** for breast cancer subtyping with the **parker.original** method.   
```R
# Load required datasets
data("OSLO2EMIT0obj")
...
Here's an example of using **BreastSubtypeR** for breast cancer subtyping with the **AIMS** method.   
```R
...
| AIMS   | BS_AIMS(...) |
| sspbc | BS_sspbc(...) |
| Multi-Method Subtyping Functionality | BS_Multi(methods = c("parker.original", "cIHC", "ssBC.v2", "sspbc",...), ...) |
