...
ui = page_fluid(
  ...
  #### Map button ####
  card(
    actionButton("map", "Map Now", icon = icon("map"), style = "color: white; background-color: #FF69B4;")
  )
  , ## layout 3
  ...
  card(
    ...
    card(
    actionButton("run", "Subtype Now", icon = icon("cog"), style = "color: white; background-color: #FF69B4;")
    )
